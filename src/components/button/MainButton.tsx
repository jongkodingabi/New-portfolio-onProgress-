...
export default function MainButton({ title }: MainButtonProps) {
  return (
    <div className="">
      <a
        href="#_"
        className="relative inline-flex items-center px-12 py-4 overflow-hidden text-lg font-medium bg-transparent text-gray-200 border-2 border-gray-600 rounded-full hover:text-black group hover:bg-gray-50"
      >
